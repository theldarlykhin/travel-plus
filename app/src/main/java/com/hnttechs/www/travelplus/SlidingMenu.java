...
public class SlidingMenu extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
            ...
            public void onDrawerClosed(View view) {
                if (mTitle.equals("ပင္မစာမ်က္ႏွာ")){
                    getSupportActionBar().setTitle("Travel Plus");
                } else {
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1:
                Intent i_fromto = new Intent(getBaseContext(),FromToSearchActivity.class);
                startActivity(i_fromto);
                break;
            case 2:
                Intent i_package = new Intent(getBaseContext(),PackageSearchActivity.class);
                startActivity(i_package);
                break;
            case 3:
                fragment = new MainActivity();
                break;
